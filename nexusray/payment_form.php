                ...
                <div class="card-header">
                        ...
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            ...
                            <li class="nav-item">
                                <a data-toggle="pill" href="#net-banking" class="nav-link"> <i
                                        class="fas fa-mobile-alt mr-2"></i> Mobile Banking </a>
                            </li>
                        </ul>
                    </div>
                    <!-- End -->
                    ...
                    <div class="tab-content">
                            ...
                            <form role="form">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="dashboard.php" >
                                        <button type="button" class="subscribe btn btn-danger btn-block shadow-sm">Back
                                            to browsing</button>
                                    </a>
                                    </div>
                                </div>
                        ...
                        <div id="net-banking" class="tab-pane fade pt-3">
                            ...
                            <div class="form-group">
                                <p>
                                    <button type="button" class="btn btn-primary"><i class="fas fa-mobile-alt mr-2"></i>
